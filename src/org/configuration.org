...
This website heavily borrows from the work of [[http://explog.in/][Kunal Bhalla]] and can be found on github [[https://github.com/julienchastang/julienchastang.com][here]] and [[https://github.com/julienchastang/julienchastang.github.io][here]]. 
...
#+BEGIN_SRC emacs-lisp :results none
  ...
  (setq
   ...
   `(,@(create-project-configuration
        "jc-notes"
        "/home/emacs/work/julienchastang/src/org"
        "/home/emacs/work/julienchastang/publish/julienchastang.github.io/")
     ("jc-static"
      :base-directory "/home/emacs/work/julienchastang/src/static/"
      :publishing-directory "/home/emacs/work/julienchastang/publish/julienchastang.github.io/static/"
      :base-extension any
      :recursive t
...
#+BEGIN_SRC emacs-lisp :eval no
  ...
  (global-set-key
   ...
   (lambda ()
     (interactive)
     (org-babel-load-file "/home/emacs/work/julienchastang/src/org/configuration.org")))
